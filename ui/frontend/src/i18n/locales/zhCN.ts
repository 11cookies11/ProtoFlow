export const zhCN = {
  ...
  'settings.plugins.directory': '插件目录',
  'settings.protocols.title': '协议包',
  'settings.filter.enabled': '已启用',
  'settings.filter.available': '可用',
  'settings.meta.unversioned': '未标注版本',
  'settings.empty.filtered': '当前筛选无结果',
  'settings.empty.noPlugins': '未发现可用插件',
  'settings.empty.noProtocols': '未发现可用协议包',
  'settings.runtime.placeholder': '暂无可配置项，运行时设置将随着模块扩展开放。',
  'settings.logs.placeholder': '日志采集与归档策略将在后续版本中提供。',
  'lang.zhCN': '简体中文',
  'lang.zhTW': '繁體中文',
