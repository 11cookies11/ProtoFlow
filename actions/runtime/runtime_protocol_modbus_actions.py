...
class ModbusRequestTask(RuntimeTaskBase):
    def __init__(self) -> None:
        super().__init__(
            name="modbus_request",
            schema={
                "required": ["protocol", "channel", "function", "address"],
                "optional": {
                    "quantity": 1,
                    "values": None,
                    "unit_id": 1,
                ...
                "types": {"quantity": "number", "unit_id": "number", "timeout": "number", "retries": "number"},
                "allow_extra": False,
            },
        )
